...
API_URL_MAPPING = {
    'terminal-register': '/api/terminal/v1/register',
    'terminal-access-key': '/api/terminal/v1/access-key',
    'terminal-heartbeat': '/api/terminal/v1/status',
    'terminal-verify': '/api/terminal/v1/verify',
    ...
    'user-assets': '/api/asset_permission/v1/user/%s/assets',
    'user-asset-groups': '/api/asset_permission/v1/user/%s/nodes-assets',
    'user-nodes-assets': '/api/asset_permission/v1/user/%s/nodes-assets',
    'my-profile': '/api/users/v1/profile/',
    'system-user-auth-info': '/api/assets/v1/systemuser/%s/info',
    'validate-user-asset-permission': '/api/perms/v1/asset-permission/user/validate',
    'finish-task': '/api/terminal/v1/task/%s',
